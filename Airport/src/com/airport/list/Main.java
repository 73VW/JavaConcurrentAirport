...
public class Main
	...
	public static void main(String[] args)
		...
		ListAvion tarmacLand = new ListAvion(nbPisteArr);
		ListAvion tarmacTakeOff = new ListAvion(nbPisteDep);
		ListAvion terminal = new ListAvion(nbPlace);
		ListAvion airDep = new ListAvion(nbAvion);

		for(int i = 0; i < nbAvion; i++)
			{
			AvionList avion = new AvionList(airportFrame, codePlane[i], airArr, tarmacLand, tarmacTakeOff, terminal, airDep, nbAvion, nbPisteArr, nbPisteDep, nbPlace);
